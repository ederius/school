...
<table>
    ...
    <tbody>
    <form class="actualizarNotasCP" id="actualizarNotasCP">
        <?php
...
<a class="btn-floating btn-large waves-effect waves-light red right actualizarNotasCP"><i class="mdi-content-add"></i></a>
