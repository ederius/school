...
<table>
    ...
    <tbody>
    <form class="actualizarNotasSP" id="actualizarNotasSP">
        <?php
...
<a class="btn-floating btn-large waves-effect waves-light red right actualizarNotasSP"><i class="mdi-content-add"></i></a>
