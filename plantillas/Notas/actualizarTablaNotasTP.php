...
<table>
    ...
    <tbody>
    <form class="actualizarNotasTP" id="actualizarNotasTP">
        <?php
...
<a class="btn-floating btn-large waves-effect waves-light red right actualizarNotasTP"><i class="mdi-content-add"></i></a>
