$(document).on("ready",function () {
    ...
    $("#cursosAlumnosPP").live("change", function(){
        ...
        $.ajax({
            type: "POST",
            url: "Notas/ActualizarNotasProfesores.php",
            data: Data,
...
// BUACAR ALUMNOS PARA NOTAS
    ...
    $("#cursosAlumnosSP").live("change", function(){
        ...
        var busqueda =$("#busquedaAlumnoSP").val();
        Data='idcurso='+idcurso+'&idjornada='+idjornada+'&busqueda='+busqueda+'&periodo='+periodo;
        $.ajax({
            type: "POST",
            url: "Notas/ActualizarNotasProfesores.php",
...
// BUACAR ALUMNOS PARA NOTAS
    $("#busquedaAlumnoSP").live("keyup", function(){
        var periodo=2
        var idcurso =$("#cursosAlumnosSP").val();
        var idjornada =$("#jornadaSP").val();
        var busqueda =$("#busquedaAlumnoSP").val();
...
// BUACAR ALUMNOS PARA NOTAS
    ...
    $("#cursosAlumnosTP").live("change", function(){
        ...
        var busqueda =$("#busquedaAlumnoTP").val();
        Data='idcurso='+idcurso+'&idjornada='+idjornada+'&busqueda='+busqueda+'&periodo='+periodo;
        $.ajax({
            type: "POST",
            url: "Notas/ActualizarNotasProfesores.php",
...
// BUACAR ALUMNOS PARA NOTAS
    $("#busquedaAlumnoTP").live("keyup", function(){
        var periodo=3
        var idcurso =$("#cursosAlumnosTP").val();
        var idjornada =$("#jornadaTP").val();
        var busqueda =$("#busquedaAlumnoTP").val();
...
// BUACAR ALUMNOS PARA NOTAS
    ...
    $("#cursosAlumnosCP").live("change", function(){
        ...
        var busqueda =$("#busquedaAlumnoCP").val();
        Data='idcurso='+idcurso+'&idjornada='+idjornada+'&busqueda='+busqueda+'&periodo='+periodo;
        $.ajax({
            type: "POST",
            url: "Notas/ActualizarNotasProfesores.php",
...
// BUACAR ALUMNOS PARA NOTAS
    $("#busquedaAlumnoCP").live("keyup", function(){
        var periodo=4
        var idcurso =$("#cursosAlumnosCP").val();
        var idjornada =$("#jornadaCP").val();
        var busqueda =$("#busquedaAlumnoCP").val();
