...
$alumnos=new Alumno();
$alumno=$alumnos->consultarAlumnosporid($id);
foreach($alumno as $a){}

$nota=new Notas();
$notas=$nota->consultarNotas($id, $periodo);

$materia=new Materia();
$materias=$materia->consultarMateriasXCurso($nombreCurso);
...
';
    ...
    $dompdf->stream("Boletin de ".$nombreCurso." periodo ".$periodo." ".$nombre.".pdf");
